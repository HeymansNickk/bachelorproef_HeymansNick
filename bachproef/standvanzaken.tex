...
\subsubsection{Docker Deamon}De Docker Daemon (\verb|dockerd|) luistert naar Docker Application programming interface (API) verzoeken en beheert Docker objecten zoals \textit{images}, \textit{containers}, netwerken, en volumes.
