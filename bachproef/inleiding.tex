...
Naarmate het gebruik van containers steeg, steeg ook de nood naar op manier om deze vanuit één centrale locatie te beheren. Om aan deze vraag te voldoen werden container orkestratie tools, zoals Kubernetes \footnote{https://kubernetes.io/}, ontwikkeld. Deze tools helpen bij het opzetten, uitbreiden en verbinden van een grote hoeveelheid containers.
...
Wat zijn de belangrijkste security risicos? Welke security tools zijn er en hoe werken ze? Welke impact hebben best practices en security tools op criteria?
