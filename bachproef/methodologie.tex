...
%Welke data er verzameld zal worden (CPU en RAM gebruik, Boot time, stability aka spikes per time) en waarom
%Uitleg over hoe deze data zal verzameld worden(sysstat) en welke grafieken er zullen gebruikt worden om een vergelijking te kunnen maken (R code tonen).
